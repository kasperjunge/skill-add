...
class CLIAssertions:
    ...
    def stdout_contains(self, text: str) -> Self:
    ...
    def stdout_not_contains(self, text: str) -> Self:
    ...
    def stdout_equals(self, expected: str) -> Self:
    ...
    def stdout_matches(self, pattern: str) -> Self:
    ...
    def stderr_contains(self, text: str) -> Self:
    ...
    def stderr_not_contains(self, text: str) -> Self:
